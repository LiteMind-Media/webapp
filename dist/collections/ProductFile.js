...
var yourOwnAndPurchased = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var user, products, ownProductFilesIds, orders, purchasedProductFilesIds;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    ownProductFilesIds = products.map(function (prod) { return prod.product_files; }).flat();
                    return [4 /*yield*/, req.payload.find({
                            collection: "orders",
                            depth: 2,
                            where: {
                ...
                case 2:
                    ...
                    return [2 /*return*/, {
                            id: {
                                in: __spreadArray(__spreadArray([], ownProductFilesIds, true), purchasedProductFilesIds, true),
                            },
                        }];
            }
        });
